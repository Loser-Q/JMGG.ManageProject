...
{
    public static class ManagePass
    {
        /// <summary>
        /// Encrypt dll锁
        /// </summary>        
        ...
        #region AES加解密(密钥满足128位,加密模式:AES/CBC/PKCS7,加密初始化向量:长度为16的空字节数组)

        /// <summary>
        /// 有密钥的AES加密,加密模式:AES/CBC/PKCS7,加密初始化向量:长度为16的空字节数组 
        /// </summary>
        /// <param name="toEncrypt"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        public static string EncryptAES128Key(string toEncrypt, string key)
        {
        ...
        /// <summary>
        /// 有密钥的AES解密,(加密模式:AES/CBC/PKCS7,加密初始化向量:长度为16的空字节数组) 
        /// </summary>
        /// <param name="toDecrypt"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        public static string DecryptAES128Key(this string toDecrypt, string key)
        {
            byte[] keyArray = UTF8Encoding.UTF8.GetBytes(key);
