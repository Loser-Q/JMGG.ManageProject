...
namespace JMGG.ManageProject.Common
{
    public class SqlHelper
    {
        ...
        {
            var connectionString = ConfigurationManager.ConnectionStrings["JMGGConnectionString"].ToString().Trim();
            //var key = ConfigurationManager.AppSettings["ConnectKey"].ToString().Trim();
            //connectionString = ManagePass.Decrypt(connectionString, key);
